...
CREATE TABLE application (
  ...
  application_no TEXT UNIQUE NOT NULL,         -- 申请单号 APP-xxx
  request_id TEXT,                              -- 请求ID REQ-xxx
...
CREATE TABLE IF NOT EXISTS policy (
  ...
  application_no TEXT NOT NULL,                -- 关联申请单
...
CREATE TABLE IF NOT EXISTS endorsement (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  endorsement_no TEXT UNIQUE NOT NULL,         -- 批改单号
  policy_no TEXT NOT NULL,                     -- 关联保单
...
CREATE TABLE IF NOT EXISTS vehicle_crm_profile (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  vehicle_policy_uid TEXT UNIQUE NOT NULL,     -- 车辆唯一标识
...
CREATE TABLE IF NOT EXISTS vehicle_crm_contacts (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  vehicle_policy_uid TEXT NOT NULL,            -- 关联车辆
...
CREATE TABLE IF NOT EXISTS renewal_reminder (
  ...
  reminder_date DATE NOT NULL,                 -- 提醒日期 (到期前30天)
...
CREATE TABLE IF NOT EXISTS query_log (
  ...
  query_key TEXT NOT NULL,                     -- 查询的关键字
  query_reason TEXT,                           -- 查询原因
  
  -- 查询来源
  source TEXT CHECK(source IN ('SALESMAN', 'CLIENT', 'SERVICE', 'ADMIN')),
  operator_id TEXT,
